    ...
    return (
        <div className="flexbox-rechtliches">
            <div className="content-rechtliches">
                ...
                <p>Scoot4fun, Verein zur Förderung der Stunt-Scooterszene in Linz und Umgebung</p>
                <p><b>ZVR:</b> xxxxx</p>
                <p><b>Vereinssitz:</b> Gallusberg 41, 4209 Engerwitzdorf, Österreich</p>
                <p><b>Organschaftliche Vertreter: Marco Fischer</b></p>
                <p>Tel.: +436604082187</p>
                <p>Email: kontakt@scooterschool.at</p>
                <p>Website: https://scooterschool.at</p>
                <p><b>Vereinszweck: Förderung der Stunt-Scooterszene in Linz und Umgebung</b></p>
                <h2>Haftung für Inhalte dieser Webseite</h2>
                <p>Wir entwickeln die Inhalte dieser Webseite ständig weiter und bemühen uns korrekte 
                    und aktuelle Informationen bereitzustellen. Leider können wir keine Haftung für die 
                    Korrektheit aller Inhalte auf dieser Webseite übernehmen, speziell für jene die seitens 
                    Dritter bereitgestellt wurden.</p>
                ...
                <p>Sollten Sie auf dieser Webseite Inhalte finden, die das Urheberrecht verletzen,
                    bitten wir Sie uns zu kontaktieren.</p>
                <h2>Bildernachweis</h2>
                <p>Die Bilder, Fotos und Grafiken auf dieser Webseite sind urheberrechtlich geschützt,
                    eine freie Verwendung ist nach Absprache jedoch erlaubt.</p>
                ...
                <p>Gemäß Verordnung über Online-Streitbeilegung in Verbraucherangelegenheiten (ODR-Verordnung) 
                    ...
                    der Europäischen Kommission unter http://ec.europa.eu/odr?tid=121679265 zu richten. 
